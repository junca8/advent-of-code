...
for str in data:
    ...
    if firstHalf1 >= secondHalf1 and firstHalf1 <= secondHalf2:
        sum += 1
    elif firstHalf2 >= secondHalf1 and firstHalf2 <= secondHalf2:
        sum += 1
    elif secondHalf1 >= firstHalf1 and secondHalf1 <= firstHalf2:
        sum += 1
    elif secondHalf2 >= firstHalf1 and secondHalf2 <= firstHalf2:
        sum += 1
